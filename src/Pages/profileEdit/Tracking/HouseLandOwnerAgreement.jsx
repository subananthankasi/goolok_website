...
export const HouseLandOwnerAgreement = ({ id, tab }) => {
    ...
    const fetchProposal = async () => {
        try {
            const response = await axiosInstance.get(`/vendor/agreehouseview/${id}`);
    ...
    const handleAgree = async () => {
        ...
        try {
            const response = await axiosInstance.post("/vendor/housesignedagree", payload);
                            ...
                            <div className="col-6">
                                <div className="d-flex justify-content-center">
                                    <div className="ownerMetaCard" style={{ width: "300px" }}>
                                        ...
                                        <div className="ownerMetaRow">
                                            <span className="ownerMetaLabel">RERA No:</span>
                                            <span className="ownerMetaValue">
                                                {ownerData?.rerano}
                                            </span>
                                        </div>
                        ...
                        {/* <div className="row ">
                            ...
                            <div className="col-md-6 mb-3">
                                <div className="p-3 border rounded shadow-sm cardheight">
                                    ...
                                    <div className="row mt-3">
                                        <div className="col-6">Total House cost:</div>
                                        <div className="col-6">
