...
export const PlotLandOwnerAgrement = ({ id, tab }) => {
    ...
    const fetchProposal = async () => {
        try {
            const response = await axiosInstance.get(`/vendor/agreeplotview/${id}`);
...
const [postLoading,setPostLoading] =useState(false)
    const handleAgree = async () => {
        ...
        try {
            const response = await axiosInstance.post("/vendor/plotsignedagree", payload);
                ...
                <>
                    ...
                    <div className="container my-4">
                        <div className="text-center mb-4">
                            ...
                            <p className="text-muted mt-3" style={{fontFamily:"poppins"}}>
                            ...
                            <div className="col-6">
                                <div className="d-flex justify-content-center">
                                    <div className="ownerMetaCard" style={{ width: "300px" }}>
                                        ...
                                        <div className="ownerMetaRow">
                                            <span className="ownerMetaLabel">Extent in unit:</span>
                                            <span className="ownerMetaValue">
                                                {ownerData?.extent_units}
                                            </span>
                                        </div>
                                        <div className="ownerMetaRow">
                        ...
                        {/* <div className="row ">
                            ...
                            <div className="col-md-6 mb-3">
                                <div className="p-3 border rounded shadow-sm cardheight">
                                    ...
                                    <div className="row mt-3">
                                        <div className="col-6">Extent in unit:</div>
                                        <div className="col-6">
                                            <b>{ownerData?.extent_units}</b>
                                        </div>
                                    </div>
                                    <div className="row mt-3">
