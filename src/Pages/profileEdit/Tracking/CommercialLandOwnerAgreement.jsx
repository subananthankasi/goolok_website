...
export const CommercialLandOwnerAgreement = ({ id, tab }) => {
    ...
    const fetchProposal = async () => {
        try {
            const response = await axiosInstance.get(`/vendor/agreecommercialview/${id}`);
    ...
    const handleAgree = async () => {
        ...
        try {
            const response = await axiosInstance.post("/vendor/commercialsignedagree", payload);
