...
export const ApartLandOwnerAgreement = ({ id, tab }) => {
    ...
    const fetchProposal = async () => {
        try {
            const response = await axiosInstance.get(`/vendor/apartagreeview/${id}`);
                            ...
                            <div className="col-6">
                                <div className="d-flex justify-content-center">
                                    <div className="ownerMetaCard" style={{ width: "300px" }}>
                                        ...
                                        <div className="ownerMetaRow">
                                            <span className="ownerMetaLabel">No Of BHK:</span>
                                            <span className="ownerMetaValue">
                                                {ownerData?.bhk_count}
                                            </span>
                                        </div>
                            ...
                            <div className="col-md-6 mb-3">
                                <div className="p-3 border rounded shadow-sm cardheight">
                                    ...
                                    <div className="row mt-3">
                                        ...
                                        <div className="col-6">
                                            <b>{ownerData?.bhk_count}</b>
                                        </div>
                                    </div>
                                    <div className="row mt-3">
                                        <div className="col-6">Super Built Up Area:</div>
                                        <div className="col-6">
                                            <b>{ownerData?.saleable_area}</b>
                                        </div>
                                    </div>
                                    <div className="row mt-3">
