...
const ServiceStatusMissingDocuments = ({ eid }) => {
  ...
  const steps = [
    ...
    {
      title: "Missing Documents Invoice Payment",
      details: (
    ...
    {
      title: "Your Missing Documents",
      details: (
        <YourMissingDocuments
...
export default ServiceStatusMissingDocuments;
              ...
              <div className="card">
                ...
                <div className="d-flex justify-content-between">
                  <div className="d-flex gap-1 px-2">
                    ...
                    <p className="mb-3 "> {item.doc_type}.pdf </p>
                  </div>
            ...
            <div className="d-flex justify-content-between ">
              <div className="mt-3 mb-5">
                ...
                <div className="m-0">
                  ...
                  <p className="p-0 m-0" style={{ fontSize: "11px" }}>
                    {" "}
                    <b>Nungambakkam, Chennai,</b>{" "}
                  </p>
                  <p className="p-0 m-0" style={{ fontSize: "11px" }}>
                    {" "}
                    <b>Tamil Nadu 600034 </b>
                  </p>
                </div>
              </div>
              <div className="mt-3 mb-5">
                ...
                <p className="p-0 m-0" style={{ fontSize: "11px" }}>
                  <b> Name: </b> {invoiceData[0]?.customer}{" "}
                </p>
                <p className="p-0 m-0" style={{ fontSize: "11px" }}>
                  <b> Date:</b> {invoiceData[0]?.invoice_date}{" "}
                </p>
                <p className="p-0 m-0" style={{ fontSize: "11px" }}>
                  <b> Email:</b>
            ...
            <section className="line-items  ">
              <table className="items--table w-100 mt-5 p-2 table-bordered">
                <thead className="p-1">
                  <tr className="p-1">
                    ...
                    <th className="text-center" style={{ fontSize: "11px" }}>
                      Qty
                    </th>
                    <th className="text-center" style={{ fontSize: "11px" }}>
                      Description
              ...
              <div>
                {invoiceData[0]?.invoice_status === "pending" ? (
                  invoiceData[0]?.service_cat === "Missing Documents" ? (
...
const YourMissingDocuments = ({ docData, fetchInvoice, eid }) => {
  return (
    <>
      <div className="m-3">
        <div className="d-flex justify-content-center" style={{ flexWrap: "wrap", gap: "20px" }}>
          {docData?.missingdoc?.length === 0 ? (
            <div style={{ textAlign: "center", padding: "20px" }}>
              <h6
                style={{
                  fontFamily: "Poppins",
          ...
          ) : docData?.missingdoc.map((item, index) => (
            <div className=" ">
