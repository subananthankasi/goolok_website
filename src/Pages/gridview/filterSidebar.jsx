...
function FilterSidebar(FilterHide) {
   const options = [
    ...
    <>
     {/* <div className="row">
      ...
      <div className="filterMobileView">
        <div
          className=" "
          style={{ float: "right", display: "flex", width: "100%" ,justifyContent:'end'}}
        > 
          <a href="# " className="btn_1 w-50" style={{background:'#fead42'}} onClick={handleShow}>
