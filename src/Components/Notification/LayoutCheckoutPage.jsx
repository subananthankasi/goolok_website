...
const LayoutCheckoutPage = () => {
    ...
    const { selectedPlot, checkValue } = location.state;
    ...
    const handlePayment = async () => {
        const selectedOption = selectedOptions[selectedPlot.vacantId];
        ...
        const selectedSchedules = Object.entries(selectedOptions).map(
            ([vacantId, schedule]) => ({
                vacantId,
                schedule,
                payment_type: checkValue ? "without" : "with",
            }),
        );
        const payload = {
            amount: selectedPlot?.booking_amount,
            vacantid: [selectedPlot?.vacantId],
            option: selectedSchedules,
            plotcost: checkValue
                ? selectedPlot?.total_without_registration
                : selectedPlot?.total_with_registration,
        };
        ...
        try {
            ...
            const options = {
                ...
                amount: selectedPlot?.booking_amount * 100,
                currency: "INR",
    ...
    return (
        <>
            <div className="container checkout-address p-3 p-lg-5 poppins">
                <div className="row">
                    <div
                                ...
                                <>
                                    <div className="row p-2">
                                        <div className="col-lg-10 col-12">
                                            <h6 style={{ fontSize: "12x" }}>Your Address : </h6>
                                            <p style={{ color: "gray" }}>
                        ...
                        <div className="card mt-1 " style={{ minHeight: "200px" }}>
                            <div className="row p-4">
                                <div className="col-md-3 col-12">
                                    <img
                                        src={`${IMG_PATH}enquiry/gallery/${selectedPlot.image}`}
                                        alt="land"
                                        className="rounded"
                                ...
                                <div className="col-md-9 col-12 mt-2 mt-md-0">
                                    <div className="d-flex justify-content-between">
                                        <h6 style={{ fontFamily: "poppins", color: "#0000ff" }}>
                                            <strong>{selectedPlot.landType}</strong>
                                        </h6>
                                    </div>
                                    <div className="d-flex justify-content-between">
                                        <p style={{ fontSize: "13px" }} className="mt-1">
                                            {selectedPlot.propertyName}
                                        </p>
                                        <p
                                            style={{ fontSize: "13px", fontWeight: "600" }}
                                            className="mt-1"
                                        >
                                            Plot No : {selectedPlot.plot_no}
                                        </p>
                                    </div>
                                    ...
                                    <div className="d-flex justify-content-between text-start flex-column flex-md-row">
                                        <p className="mb-0 m-0 p-0" style={{ fontSize: "13px" }}>
                                            Unit : {selectedPlot.extent_sqft}
                                        </p>
                                        <p style={{ color: "", fontSize: "13px" }}>
                                            Booking Amount :
                                            <span style={{ color: "#0000ff", marginLeft: "5px" }}>
                                                ₹{" "}
                                                {selectedPlot.booking_amount
                                                    ? selectedPlot.booking_amount
                                                    : 0}{" "}
                                            </span>
                                        </p>
                                    ...
                                    <div className="mt-1">
                                        ...
                                        <RadioGroup
                                            name={`paymentOption_${selectedPlot.vacantId}`}
                                            value={selectedOptions[selectedPlot.vacantId] || null}
                                            onChange={(value) =>
                                                handleOptionChange(selectedPlot.vacantId, value)
                                            }
                                        >
                                            <div className="row">
                                                {selectedPlot.pay_option?.map((option, index) => (
                                                    <div
                                                        key={index}
                                        ...
                                        {!selectedOptions[selectedPlot.vacantId] && showTooltip && (
                            ...
                            <div className="card mt-1 p-3" style={{ minHeight: "346px" }}>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-5">
                                        ...
                                        >
                                            ₹
                                            {((responseCoupon?.final_total ?? checkValue)
                                                ? selectedPlot?.total_without_registration
                                                : selectedPlot?.total_with_registration
                                    ...
                                    >
                                        ...
                                        >
                                            {paymentLoading ? (
                                                ...
                                                `PROCEED TO PAY ${selectedPlot?.booking_amount}`
                                            )}
                                        </button>
                                    </Whisper>
                                </div>
